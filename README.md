...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/where-u-at-cfw)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/where-u-at-cfw
```

A live public deployment of this template is available at [https://where-u-at-cfw.templates.workers.dev](https://where-u-at-cfw.templates.workers.dev)
